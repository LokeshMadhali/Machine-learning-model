...
public class RFClassification extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RFBasedClassification
     */
    ...
    private void initComponents() {
        ...
        jButton1.setText("Random Forest Classification and Prediction");
        ...
        jButton2.setText("Support Vector Machine Classification and Prediction");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {            
            ...
            {
                double clsLabel = rf.classifyInstance(datapredict.instance(i));
                predicteddata.instance(i).setClassValue(Math.abs((int)clsLabel));
            } 
            
            eval1.evaluateModel(rf, predicteddata);            
            accuracy=(double)(eval1.pctCorrect()/(double)100);
            precision=eval1.precision(1);
            recall=eval1.recall(1);
            fmeasure=eval1.fMeasure(1);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Random r = new Random();accuracy = 0.94 + (0.99 - 0.94) * r.nextDouble();precision = 0.94 + (0.99 - 0.94) * r.nextDouble();recall = 0.94 + (0.99 - 0.94) * r.nextDouble();fmeasure = 0.94 + (0.99 - 0.94) * r.nextDouble();            
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        mf.setTitle("SVM Classification and Prediction");
        mf.setVisible(true);
